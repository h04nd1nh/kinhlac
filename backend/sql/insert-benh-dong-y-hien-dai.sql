...
('HD005', 'Đau lưng do viêm đại tràng', 'AD6',
 ...
 'E13>0 AND E14>0 AND E15>0 AND LEN(AP14)>0 AND OR(AND(AN21*AQ21<0;AN22*AQ22<0);AND(AN21*AQ21>0;AN22*AQ22>0;H21>D18;H22>D18))',
 'CASE WHEN E13>0 AND E14>0 AND E15>0 AND LEN(AP14)>0 AND ((AN21*AQ21<0 AND AN22*AQ22<0) OR (AN21*AQ21>0 AND AN22*AQ22>0 AND H21>D18 AND H22>D18)) THEN ''Đau lưng do viêm đại tràng'' ELSE '''' END',
 'CASE WHEN E13>0 AND E14>0 AND E15>0 AND LEN(AP14)>0 AND ((AN21*AQ21<0 AND AN22*AQ22<0) OR (AN21*AQ21>0 AND AN22*AQ22>0 AND H21>D18 AND H22>D18)) THEN TRUE ELSE FALSE END'),
