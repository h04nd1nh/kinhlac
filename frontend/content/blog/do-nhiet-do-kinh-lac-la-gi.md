...
Theo lý luận Đông Y, cơ thể có **12 đường kinh chính**, mỗi đường kinh liên hệ với một tạng hoặc một phủ (như Phế, Tỳ, Can, Thận, Tâm, Đại Trường…). Khi một tạng phủ mất cân bằng, sự thay đổi đó được cho là phản ánh ra trên đường kinh tương ứng.

Phương pháp **đo nhiệt độ kinh lạc** tập trung đo tại các **tỉnh huyệt** — nhóm huyệt nằm ở đầu các ngón tay, ngón chân, được Đông Y xem là nơi "khí" của mỗi đường kinh khởi phát hoặc tận cùng. Bằng cách so sánh nhiệt độ giữa các tỉnh huyệt với nhau và với một mức tham chiếu, ta có thể ước lượng đường kinh nào đang thiên về **hàn** (lạnh, thường gắn với hư) hay **nhiệt** (nóng, thường gắn với thực).

Cần nói rõ: đây là một **công cụ hỗ trợ chẩn đoán**, không thay thế khám lâm sàng, bắt mạch hay các xét nghiệm của Tây Y. Kết quả đo là dữ liệu tham khảo để thầy thuốc biện chứng, chứ không phải một kết luận bệnh tự động.

## Nguyên Lý 24 Tỉnh Huyệt

Vì sao lại là con số **24 tỉnh huyệt**? Cơ thể có 12 đường kinh chính, mỗi đường kinh đối xứng hai bên trái – phải. Mỗi bên có 6 đường kinh ở tay và 6 đường kinh ở chân; ta đo tỉnh huyệt đại diện của từng đường kinh. Cộng cả hai bên, một lần đo đầy đủ ghi nhận nhiệt độ tại 24 điểm đầu ngón, phản ánh trạng thái của trọn vẹn **12 đường kinh** ở cả hai phía cơ thể.

Cách diễn giải số liệu, nói một cách đơn giản, dựa trên hai trục so sánh:
...
## Lịch Sử Và Nguồn Gốc Phương Pháp
...
- **Người quan tâm sức khoẻ:** muốn hiểu xu hướng cân bằng cơ thể theo góc nhìn Đông Y, từ đó trao đổi với thầy thuốc.

Phương pháp **không dành để tự chẩn đoán bệnh ở nhà** rồi tự điều trị. Giá trị lớn nhất nằm ở việc cung cấp dữ liệu cho người có chuyên môn diễn giải.

## Đọc Kết Quả Đo Như Thế Nào?

Thay vì một dãy số nhiệt độ khó hình dung, kết quả đo nên được trình bày thành **biểu đồ**: mỗi đường kinh một điểm, dễ thấy ngay kinh nào cao, kinh nào thấp, hai bên có cân hay không. Trên nền tảng Kinh Lạc, một lần đo sẽ tự động dựng biểu đồ và đối chiếu với cơ sở dữ liệu **thể bệnh – pháp trị – bài thuốc** để gợi ý hướng biện chứng.

Bạn có thể xem trực tiếp một mẫu kết quả tại [demo kết quả đo kinh lạc](/xem-ket-qua-do) để hình dung cách số liệu chuyển thành biểu đồ và nhận định.

Để hiểu sâu hơn về vị trí các huyệt và đường đi của kinh lạc trên cơ thể, hãy khám phá [đồ hình kinh lạc 3D](/xem-3d) với hơn 1.000 huyệt, hoặc tra cứu công năng – quy kinh trong [thư viện Đông Y](/thu-vien). Khi muốn xem một bài thuốc được phân tích theo **tính vị quy kinh** dưới dạng biểu đồ radar, bạn có thể tham khảo [demo phân tích bài thuốc](/xem-bai-thuoc).

## Lưu Ý An Toàn

- Kết quả **đo nhiệt độ kinh lạc** là thông tin **hỗ trợ**, không phải chẩn đoán cuối cùng và không thay thế ý kiến của thầy thuốc.
