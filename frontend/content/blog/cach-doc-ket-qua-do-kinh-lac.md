---
title: "Cách Đọc Kết Quả Đo Kinh Lạc: Kinh Cường, Kinh Nhược & Bát Cương"
...
cluster: "A"
cta: "/xem-ket-qua-do"
keywords: ["kết quả đo kinh lạc","kinh cường kinh nhược","bát cương","đo nhiệt độ kinh lạc","tỉnh huyệt","thể bệnh Đông Y","12 đường kinh"]
faq: [{"q":"Kinh cường và kinh nhược khác nhau thế nào trên bảng đo?","a":"Kinh cường có nhiệt độ trung bình cao hơn đường chuẩn của nhóm (độ lệch dương), thường được xem là gợi ý thực/nhiệt theo Đông Y. Kinh nhược có nhiệt độ thấp hơn đường chuẩn (độ lệch âm), gợi ý hư/hàn. Chỉ những kinh vượt khỏi dải dao động cho phép mới đáng lưu ý."},{"q":"Vì sao bảng đo tách riêng chi trên và chi dưới?","a":"Vì nhiệt độ tay và chân vốn khác nhau, chân thường mát hơn tay. Nếu dùng chung một mốc thì kinh chân dễ bị coi là nhược. Hệ thống tính một đường chuẩn riêng cho 6 kinh tay và một đường chuẩn riêng cho 6 kinh chân để so sánh công bằng."},{"q":"Kết quả đo kinh lạc có thay thế chẩn đoán của thầy thuốc không?","a":"Không. Kết quả đo là dữ liệu hỗ trợ biện chứng, cần kết hợp với tứ chẩn (vọng, văn, vấn, thiết) và đánh giá của thầy thuốc Đông Y. Không tự ý dùng kết quả để điều trị, nhất là với bệnh nặng hoặc phụ nữ có thai."},{"q":"Làm sao suy ra Bát Cương từ bảng nhiệt độ?","a":"Xu hướng nhiệt cao/thấp cho biết Hàn – Nhiệt; kinh cường/nhược cho biết Thực – Hư; nhóm kinh dương/âm cho biết Biểu – Lý; tổng hoà các cặp này cho biết cán cân Âm – Dương. So mức trung bình chi trên với chi dưới còn giúp nhận diện thể thượng nhiệt hạ hàn."}]
---
Khi cầm trên tay một bảng **kết quả đo kinh lạc**, nhiều người bối rối vì thấy hàng loạt con số nhiệt độ mà chưa biết bắt đầu từ đâu. Bài viết này hướng dẫn bạn cách đọc bảng đo, phân biệt **kinh cường** và **kinh nhược**, rồi từ đó suy ra **Bát Cương** và thể bệnh theo Đông Y. Phương pháp đo nhiệt độ kinh lạc — được lương y Lê Văn Sửu nghiên cứu và hệ thống hoá — dựa trên việc đo nhiệt độ tại các **tỉnh huyệt** ở đầu ngón tay, ngón chân nhằm tham khảo trạng thái hàn/nhiệt, hư/thực của từng đường kinh. Hiểu được cách đọc, bạn sẽ biến một bảng số khô khan thành bức tranh khí huyết của người bệnh phục vụ biện chứng.
...
Bạn có thể xem một bảng minh hoạ trực quan tại trang [demo kết quả đo](/xem-ket-qua-do) để vừa đọc bài vừa đối chiếu.
...
Đọc số trên giấy dễ mỏi mắt. Phần mềm Kinh Lạc chuyển bảng đo thành **biểu đồ trực quan**: kinh cường vọt lên trên đường chuẩn, kinh nhược tụt xuống dưới, độ chênh trái – phải hiện rõ. Bạn có thể thử ngay tại trang [demo kết quả đo](/xem-ket-qua-do).

Để hiểu đường đi của từng kinh và vị trí tỉnh huyệt, hãy xem [đồ hình kinh lạc 3D](/xem-3d) với hơn 1.000 huyệt, hoặc tra cứu công năng từng huyệt trong [thư viện Đông Y](/thu-vien). Khi đã có hướng pháp trị, bạn có thể tham khảo cách [phân tích bài thuốc theo tính vị quy kinh](/xem-bai-thuoc) để xem bài thuốc tác động vào những đường kinh nào.
