...
const dataList = ref<MeridianModel[]>([])
  ...
  <div class="management-page">
    <div class="page-header">
      <div class="header-content">
        ...
        <p class="page-subtitle">Danh sách các mô hình bệnh lý và thể bệnh kinh lạc</p>
      </div>
    </div>
    ...
    <div v-else class="content-body">
      <div class="data-card">
        <div class="card-header">
          <h3>Mô Hình Bệnh Lý</h3>
          <span class="badge badge-info">{{ dataList.length }} mô hình</span>
        </div>
          ...
          <table class="data-table">
            ...
            <tbody>
              ...
              <tr v-for="item in dataList" :key="item.id">
                <td>#{{ item.id }}</td>
                <td class="font-bold text-brown-900">{{ item.ten_mo_hinh }}</td>
