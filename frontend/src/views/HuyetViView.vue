...
.chip-kinh { background: #ecfdf5; color: #047857; border-color: #a7f3d0; }
.chip-code { background: #eff6ff; color: #1d4ed8; border-color: #bfdbfe; font-family: ui-monospace, monospace; }
.chip-type { background: #fef3c7; color: #92400e; border-color: #fcd34d; }
