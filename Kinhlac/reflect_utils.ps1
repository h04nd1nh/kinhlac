...
$type = [System.AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.Location -like "*Kinhlac.exe" } | ForEach-Object { $_.GetType("Kinhlac.Utilities") } | Where-Object { $_ -ne $null }

if ($type) {
    Write-Output "Methods in $($type.FullName):"
